...
export default function LandingPage() {
      ...
      avatars={[
        {
          ...
          alt: "Portrait of confident businessman",
        },
        {
          src: "http://img.b2bpic.net/free-photo/dark-blonde-bearded-man-crosses-his-hands-chest-posing-black-shirt_8353-1116.jpg",
          alt: "Dark blonde bearded man",
        },
        {
        ...
        },
        {
          ...
          alt: "Attractive blond male",
        },
        {
          src: "http://img.b2bpic.net/free-photo/creative-portrait-beautiful-woman_23-2149150308.jpg",
          alt: "Creative portrait of woman",
        },
      ]}
  ...
  <div id="about" data-section="about">
      ...
      heading={[
        {
          type: "text",
          content: "Ние създаваме опит, не просто сайтове.",
        },
        {
          type: "image",
          src: "http://img.b2bpic.net/free-photo/cool-different-office-stationery-arranged-white-table-co-working-office_285396-1791.jpg",
          alt: "Studio process",
        },
      ]}
    />
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          ...
          date: "2024",
          title: "Мениджър",
          quote: "Сайтът увеличи запитванията ни двойно.",
          tag: "Успех",
          avatarSrc: "http://img.b2bpic.net/free-photo/beautiful-painter-white-shirt-chair-dreamily-looking-camera-while-holding-paint-brushes-hand-home_574295-3798.jpg",
          imageSrc: "http://img.b2bpic.net/free-photo/cool-different-office-stationery-arranged-white-table-co-working-office_285396-1791.jpg",
          imageAlt: "professional man portrait",
        },
        {
          id: "3",
      ...
      metrics={[
        {
          ...
          value: "100+",
          title: "Проекта",
          description: "Успешно реализирани",
          icon: CheckCircle,
        },
        {
          id: "m2",
          value: "50+",
          title: "Клиенти",
          description: "Доволни партньори",
          icon: Star,
        },
        {
          id: "m3",
          value: "99%",
          title: "Удовлетвореност",
          description: "Средна оценка",
          icon: Award,
        },
      ]}
      title="Нашите успехи"
      ...
      faqs={[
        {
          ...
          content: "Обикновено от 2 до 4 седмици.",
        },
        {
          id: "2",
          title: "Мога ли да си редактирам сайта?",
          content: "Да, предоставяме лесен за управление интерфейс.",
        },
        {
          id: "3",
          title: "Предлагате ли поддръжка?",
          content: "Да, предлагаме абонаментни планове за поддръжка.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      description="Готови ли сте да започнем вашия проект?"
      inputs={[
        {
          name: "name",
          type: "text",
